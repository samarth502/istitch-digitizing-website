...
export const HearFromClient: React.FC = () => {
  ...
  return (
    <div className="bg-lightGray overflow-hidden  flex flex-col justify-center items-center px-4 md:px-10 xl:px-28">
      <h1 className="text-center pb-6 text-[32px] font-semibold">
